...
<div style="max-width:520px;margin:3rem auto;">
  ...
  <div class="form-card" style="max-width:100%;">
    <form method="POST" action="/SwiftCargo/public/user/track" id="track-form">
      ...
      <button type="submit" class="btn btn-primary btn-full btn-lg" id="btn-track">🔍 Track Shipment</button>
    </form>
  </div>
</div>
