...
<div class="page-header">
  ...
  <a href="/SwiftCargo/agent/shipments/create" class="btn btn-primary" id="btn-agent-new">âž• New Shipment</a>
</div>
    ...
    <table>
      ...
      <tbody>
        <?php if (empty($shipments)): ?>
          <tr><td colspan="8"><div class="empty-state"><div class="icon">ðŸ“­</div><p>No shipments for your branch</p></div></td></tr>
        <?php else: ?>
          ...
          <tr>
            ...
            <td><a href="/SwiftCargo/agent/shipments/edit/<?= $s['id'] ?>" class="btn btn-warning btn-sm">âœ Update</a></td>
          </tr>
          <?php endforeach; ?>
        <?php endif; ?>
      </tbody>
