  ...
  <form method="POST" action="/SwiftCargo/public/agent/shipments/store" id="agent-create-shipment">
    ...
    <div class="form-group">
      ...
      <select name="sender_city_id" id="sender_city_id" class="form-control" required>
        ...
        <?php foreach ($cities as $city): ?><option value="<?= $city['id'] ?>"><?= htmlspecialchars($city['name']) ?></option><?php endforeach; ?>
      </select>
    </div>
    ...
    <div class="form-row three">
      <div class="form-group">
        <label class="form-label" for="courier_type">Type</label>
      ...
      <div class="form-group"><label class="form-label" for="weight">Weight (kg)</label><input type="number" name="weight" id="weight" class="form-control" step="0.01" min="0.01" required></div>
      <div class="form-group"><label class="form-label" for="amount">Amount (Rs.)</label><input type="number" name="amount" id="amount" class="form-control" step="0.01" min="0" required></div>
    </div>
