...
<div class="form-card">
  <form method="POST" action="/SwiftCargo/public/admin/shipments/update/<?= $shipment['id'] ?>" id="edit-shipment-form">
    ...
    <div style="display:flex;gap:1rem;margin-top:0.5rem;">
      <button type="submit" class="btn btn-primary btn-lg" id="btn-update-shipment">💾 Update Status</button>
