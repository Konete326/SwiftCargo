...
<div class="card">
  <div class="card-header">
    ...
    <a href="/SwiftCargo/public/admin/shipments" class="btn btn-outline btn-sm">View All</a>
  </div>
    ...
    <table>
      ...
      <tbody>
        <?php if (empty($recentShipments)): ?>
          <tr><td colspan="6"><div class="empty-state"><div class="icon">📭</div><p>No shipments yet</p></div></td></tr>
        <?php else: ?>
          ...
          <tr>
            ...
            <td><?= htmlspecialchars($s['from_city']) ?> → <?= htmlspecialchars($s['to_city']) ?></td>
